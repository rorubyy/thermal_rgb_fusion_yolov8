...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.train_rgb_set, self.test_rgb_set, self.train_ir_set, self.test_ir_set = self.get_dataset(self.data)
        self.ema = None
    ...
    def get_dataset(data):
        ...
        """
        return data['train_rgb'], data['val_rgb'], data['train_ir'], data['val_ir']
